...
new.cluster.ids <- c("CD8_T","CD8_T","CD4_T","CD8_T","CD4_T","Innate_lymphoid",
...
Innate_lymphoid<-subset(hms_cluster_id, idents=c('Innate_lymphoid'))
DimPlot(Innate_lymphoid, reduction = "umap")
saveRDS(Innate_lymphoid, file="Innate_lymphoid.rds")
